...
- (void)viewDidLoad {
    ...
    ProductionView *proViews = [[ProductionView alloc] initWithFrame:CGRectMake(0, k_Height_NavBar, ScreenWidth, ScreenHeight-k_Height_NavBar)];
